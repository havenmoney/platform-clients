...
import dev.haven.jclient.auth.HttpBasicAuth;
import dev.haven.jclient.auth.HttpBearerAuth;
import dev.haven.jclient.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://haven.dev/api";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
