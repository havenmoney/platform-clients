...
#ifndef DEV_HAVEN_CLIENT_MODEL_RawMerchantStore_H_
#define DEV_HAVEN_CLIENT_MODEL_RawMerchantStore_H_
...
/// 
/// </summary>
class  RawMerchantStore
    : public ModelBase
{
public:
    RawMerchantStore();
    virtual ~RawMerchantStore();
...
#endif /* DEV_HAVEN_CLIENT_MODEL_RawMerchantStore_H_ */
