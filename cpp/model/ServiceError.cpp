...
void ServiceError::validate()
{
    // TODO: implement validation
}

web::json::value ServiceError::toJson() const
{
...
void ServiceError::fromJson(const web::json::value& val)
{
    setMessage(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("message"))));
}

void ServiceError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void ServiceError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t ServiceError::getMessage() const
{
    return m_Message;
}

void ServiceError::setMessage(const utility::string_t& value)
{
    m_Message = value;
